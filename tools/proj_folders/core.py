"""
Project folder structure builders — create, update, and preview
project / asset / shot directory trees.

This module uses the generic folder-spec engine from lightwarp.folders
and the structure definitions from config/.
"""
